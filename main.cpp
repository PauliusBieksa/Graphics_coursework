...
bool load_content()
{
	...
	array<string, 6> filenames = { "res/textures/skybox/posx.jpg", "res/textures/skybox/negx.jpg", "res/textures/skybox/posy.jpg",
	...
	// Load normal maps, meshes and textures
	{
		// Load normal maps
		{
			normal_maps["wall0"] = texture("res/textures/CeramicBrick_normalmap_M.jpg");
			normal_maps["deviceFrameBottom"] = texture("res/textures/Copper_A_normalmap_M.png");
		...
		// Load meshes
		{
			...
			meshes["arch0"] = turbo_mesh(geometry("res/models/arch.obj"));
			...
			meshes["lamppost0"] = turbo_mesh(geometry("res/models/lamp.obj"));
			...
			meshes["lamppost1"] = turbo_mesh(geometry("res/models/lamp.obj"));
			...
			meshes["spotlight0"] = turbo_mesh(geometry("res/models/street lamp.obj"));
			meshes["spotlight0"].get_transform().position = vec3(-18.5f, 0.0f, 5.0f);
			meshes["spotlight0"].get_transform().scale = vec3(0.1f, 0.1f, 0.1f);

			meshes["flashlight0"] = turbo_mesh(geometry("res/models/Flashlight.obj"));
		...
		// Load textures
		{
			texs["check_1"] = texture("res/textures/check_1.png", true, true);
			texs["floor"] = texture("res/textures/Asphalt.jpg", true, true);
			texs["arch0"] = texture("res/textures/concrete.jpg", true, true);
			texs["lamppost0"] = texture("res/textures/st-metal.jpg", true, true);
			texs["lamppost1"] = texs["lamppost0"];
			texs["wall0"] = texture("res/textures/CeramicBrick_albedo_M.jpg", true, true);
			texs["wall1"] = texture("res/textures/map-8.jpg", true, true);
			texs["spotlight0"] = texs["lamppost0"];
			texs["deviceFrameBottom"] = texture("res/textures/Copper_A_albedo_M.png", true, true);
			...
			masks["mainMenu"] = texture("res/textures/MenuMain.png", true, true);
			masks["portalMenu"] = texture("res/textures/MenuPortal.png", true, true);
			masks["colourMenu"] = texture("res/textures/MenuColour.png", true, true);
			masks["helpMenu"] = texture("res/textures/MenuHelp.png", true, true);
	...
	// Load in shaders
	{
		eff.add_shader("res/shaders/vert_shader.vert", GL_VERTEX_SHADER);
		vector<string> frag_shaders{ "res/shaders/top_shader.frag", "res/shaders/directional.frag", "res/shaders/spot.frag", "res/shaders/point.frag", "res/shaders/shadow_index.frag" };
		eff.add_shader(frag_shaders, GL_FRAGMENT_SHADER);

		portal_eff.add_shader("res/shaders/vert_shader.vert", GL_VERTEX_SHADER);
		vector<string> portal_frag_shaders{ "res/shaders/portal_top_shader.frag", "res/shaders/directional.frag", "res/shaders/spot.frag", "res/shaders/point.frag", "res/shaders/shadow_index.frag" };
		portal_eff.add_shader(portal_frag_shaders, GL_FRAGMENT_SHADER);

		shadow_eff.add_shader("res/shaders/shadow_depth.vert", GL_VERTEX_SHADER);

		colour_eff.add_shader("res/shaders/simple.vert", GL_VERTEX_SHADER);
		colour_eff.add_shader("res/shaders/colour_correction.frag", GL_FRAGMENT_SHADER);

		sky_eff.add_shader("res/shaders/skybox.vert", GL_VERTEX_SHADER);
		sky_eff.add_shader("res/shaders/skybox.frag", GL_FRAGMENT_SHADER);

		mask_eff.add_shader("res/shaders/simple.vert", GL_VERTEX_SHADER);
		mask_eff.add_shader("res/shaders/mask.frag", GL_FRAGMENT_SHADER);
